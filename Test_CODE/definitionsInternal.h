...
// ------------------------------------------------------------------------
EXPORT_FUNC void pushMergedNeuronInitGroup0ToDevice(unsigned int idx, unsigned int* spkCnt, unsigned int* spk, curandState* rng, double* inSynInSyn0, double* inSynInSyn1, double* inSynInSyn2, unsigned int numNeurons);
...
EXPORT_FUNC void pushMergedNeuronInitGroup3ToDevice(unsigned int idx, unsigned int* spkCnt, unsigned int* spk, curandState* rng, double* inSynInSyn0, double* inSynInSyn1, unsigned int numNeurons);
EXPORT_FUNC void pushMergedSynapseDenseInitGroup0ToDevice(unsigned int idx, scalar constantg, scalar* g, unsigned int rowStride, unsigned int numSrcNeurons, unsigned int numTrgNeurons);
