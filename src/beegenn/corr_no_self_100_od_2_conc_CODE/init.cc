...
__device__ unsigned int d_mergedSynapseConnectivityInitGroupStartID0[] = {14656, };
__device__ unsigned int d_mergedSynapseConnectivityInitGroupStartID1[] = {15488, 19520, };
__device__ unsigned int d_mergedSynapseConnectivityInitGroupStartID2[] = {20352, };
